<form action="{{ route('dams.store') }}" method="post">
    ...
    <input type="number" name="lenguajes_marcas_grade" id="lenguajes_marcas_grade" placeholder = 'Numero entre 1-10'><br>

    <label for="sistemas_informaticos_grade">Nota de sistemas informaticos:</label>
    <input type="number" name="sistemas_informaticos_grade" id="sistemas_informaticos_grade" placeholder = 'Numero entre 1-10'><br>
